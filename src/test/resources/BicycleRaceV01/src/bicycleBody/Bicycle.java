...
/**
 * <h1>Bicycle</h1>
 * Class responsible for handling all the functionality that is needed for a bicycle.
 *
 * @version 1.0
 * @since 2017-07-24
 */
public class Bicycle
{
    ...
    /**
     * Computes the velocity of the bicycle based on the pedaling rate.
     *
    ...
    /**
     * Computes the velocity of the bicycle based on the given braking force.
     *
    ...
    /**
     * Reports the information regarding a bicycle (velocity and status)
     */
