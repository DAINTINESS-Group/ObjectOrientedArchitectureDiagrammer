...
/**
 * <h1>NaiveAnalyser</h1>
 * Responsible for (a) the production of phases from a timeline and (b) the reporting to the console
 *
 * @version 1.0
 * @since 2017-07-23
 */
public final class NaiveAnalyser implements IAnalyser
{
     ...
     * <p>
     * //TODO (NOT YET)	ArrayList<String> resultText = new ArrayList<String>(); //	ArrayList<Phase> phases = new ArrayList<Phase>();
     */
    @Override
