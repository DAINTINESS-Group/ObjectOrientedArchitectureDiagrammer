...
* Responsible for displaying the cart information.
* In addition, provides the user the ability to delete
* any of the items that are added to the cart.
*
* @version 1.0
* @since   2017-07-17
*/
...
public class CartController {
	 @FXML private TableView<ShopItem> cartItemTable;
	 @FXML private TableColumn<ShopItem, String> cartItemTitle;
	 @FXML private TableColumn<ShopItem, String> cartItemPrice;
	 @FXML
	 ObservableList<ShopItem> cartItems = FXCollections.observableArrayList();
	 @FXML private Label totalCost = new Label();
