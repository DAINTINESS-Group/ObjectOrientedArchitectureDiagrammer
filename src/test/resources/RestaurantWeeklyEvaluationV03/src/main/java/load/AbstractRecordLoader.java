...
abstract class AbstractRecordLoader <E>{
	/**
	 * An abstract method (to be implemented at concrete classes) that converts a string array to a concrete object
	 * depending on what kind of objects are being instantiated by the loader
	 * 
