...
class JDTProjectParserTest {
	...
	void parsingTest() {
		...
		List<Path> viewsLeafNodes = new ArrayList<>(Arrays.asList(
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/view/ChooseTemplate.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/view/LatexEditorView.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/view/MainWindow.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/view/OpeningWindow.java")
				));
		...
		List<Path> strategiesLeafNodes = new ArrayList<>(Arrays.asList(
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/model/strategies/StableVersionsStrategy.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/model/strategies/VersionsStrategy.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/model/strategies/VolatileVersionsStrategy.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/model/strategies/VersionsStrategyFactory.java")
				));
		List<Path> modelsLeafNodes = new ArrayList<>(Arrays.asList(
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/model/Document.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/model/DocumentManager.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/model/VersionsManager.java")
				));
		List<Path> commandsLeafNodes = new ArrayList<>(Arrays.asList(
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/controller/commands/AddLatexCommand.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/controller/commands/Command.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/controller/commands/CommandFactory.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/controller/commands/CreateCommand.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/controller/commands/EditCommand.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/controller/commands/LoadCommand.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/controller/commands/SaveCommand.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/controller/commands/ChangeVersionsStrategyCommand.java"),
				Paths.get(PathConstructor.getCurrentPath().normalize().toString(), "/src/test/resources/LatexEditor/src/controller/commands/DisableVersionsManagementCommand.java"),
		...
		assertEquals(Paths.get(PathConstructor.getCurrentPath().normalize().toString(),
				PathConstructor.constructPath("src", "test", "resources", "LatexEditor", "src", "controller", "commands")), controllerPackage.getPackageNodesPath());
		assertEquals(Paths.get(PathConstructor.getCurrentPath().normalize().toString(),
		...
		assertEquals(Paths.get(PathConstructor.getCurrentPath().normalize().toString(),
				PathConstructor.constructPath("src", "test", "resources", "LatexEditor", "src", "controller", "commands")), commandsPackage.getParentNode().getPackageNodesPath());
