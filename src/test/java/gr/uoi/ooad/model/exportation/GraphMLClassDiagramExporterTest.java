...
public class GraphMLClassDiagramExporterTest {
    ...
    void exportDiagramTest() {
        try {
            ...
            Map<Integer, Pair<Double, Double>> nodesGeometry =
                    classDiagramArrangement.arrangeGraphMLDiagram();
    ...
    private static String getExpectedFileContents(ClassDiagramManager classDiagramManager) {
        ...
        StringBuilder graphMLNodeBuffer =
        ...
        StringBuilder graphMLEdgeBuffer =
