...
public class FileUtility {
    ...
    public static File saveFile(String windowTitle, MenuBar menuBar, String fileType) {
        final Map<String, String> availableExtensionTypes =
                Map.ofEntries(
        ...
        fileChooser
                ...
                .add(
                        new FileChooser.ExtensionFilter(
                                fileType, availableExtensionTypes.get(fileType)));

        String suffix =
                fileType.equals("PlantUML Files") || fileType.equals("PlantUML Text Files")
                        ? "_plantUML"
                        : "_createdDiagram";
        ...
        fileChooser.setInitialFileName(
                selectedDirectory.getName()
                        + suffix
                        + availableExtensionTypes.get(fileType).substring(1));
    ...
    public static File saveLoadedFile(String windowTitle, MenuBar menuBar, String fileType) {
        final Map<String, String> availableExtensionTypes =
                Map.ofEntries(entry("Text Files", "*.txt"), entry("PNG files", "*.png"));
        FileChooser fileChooser = new FileChooser();
        fileChooser.setTitle(windowTitle);
        fileChooser.setInitialDirectory(new File(System.getProperty("user.home")));
        fileChooser
