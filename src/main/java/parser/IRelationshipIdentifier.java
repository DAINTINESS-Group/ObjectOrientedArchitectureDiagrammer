 ...
 * branches have a type, e.g., inheritance, implementation. The branches are also directed with a
 * starting and an ending node.
 */
public interface IRelationshipIdentifier {
     ...
     */
    Map<LeafNode, Set<Relationship<LeafNode>>> createLeafNodesRelationships(
