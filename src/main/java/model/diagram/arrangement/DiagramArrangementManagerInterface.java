...
public interface DiagramArrangementManagerInterface
{
    ...
    /**
     * This method is responsible for the arrangement of the graph by creating a graph of the Jung library and using the SpringLayout algorithm.
     *
    ...
    /**
     * This method is responsible for the arrangement of the graph by creating a graph of the Jung library and using different layout algorithms.
     *
