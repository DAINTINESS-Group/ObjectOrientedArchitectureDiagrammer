...
public interface DiagramManager
{
    ...
    /**
     * This method converts the tree created by the Parser to a Diagram,
     * based on the files(classes or packages) selected by the designer.
     * The type of the Diagram depends on the type of files the designer has chosen
     * and the Controller is responsible for creating the corresponding GraphDiagramManager
     * that implements the createDiagram method.
     *
    ...
    /**
     * This method arranges the createdDiagram's node geometry by creating a Jung Graph
     * and then applying the SpringLayout algorithm, implemented by the Jung library.
     */
    DiagramGeometry arrangeDiagram();

    /**
     * This method exports the created diagram to a file, to the path selected by the designer,
     * in GraphMLFormat, by converting the nodes and edges to GraphML syntax.
     *
    ...
    /**
     * This method saves the created JavaFX diagram to a text file, to the path selected by the designer,
     * by implementing a Map that stores the diagrams' nodes as keys and a Map of their edges and the relationship type as their values.
     *
    ...
    /**
     * This method loads a JavaFX diagram from a file, selected by the designer,
     * by creating an object of the class Diagram and populating the createdDiagram Collection
     * with the contents of the file.
     * The createdDiagram is a Map as described in the method above.
     *
